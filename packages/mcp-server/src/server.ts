...
import { ClientOptions } from 'solargystix';
...
export { ClientOptions } from 'solargystix';
...
async function getInstructions() {
  ...
  const response = await fetch(
    readEnv('CODE_MODE_INSTRUCTIONS_URL') ?? 'https://api.stainless.com/api/ai/instructions/solargystix',
    {
      method: 'GET',
  ...
  if (!response.ok) {
    ...
    instructions = `
      This is the solargystix MCP server. You will use Code Mode to help the user perform
