...
```sh
npm install git+ssh://git@github.com:stainless-sdks/solargystix-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install solargystix`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/solargystix-typescript/issues) with questions, bugs, or suggestions.
