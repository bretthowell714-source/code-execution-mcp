import fs from 'fs';
import type { ResponseLike } from 'solargystix/internal/to-file';
import { toFile } from 'solargystix/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('solargystix/core/uploads');
    await expect(
